...
public class ExtentManager {
    ...
    public static String reportFileName = GetFrameworkKeys.getPropValue("ReportName") + "_"+ dateFormat();
    public static String reportSubFilePath = "CompanyNameReports"+ "_"+ dateFormat();
    public static String reportFilepath = System.getProperty("user.dir") + File.separator + "GeneratedReport"+ File.separator + reportSubFilePath;
...
//        extentHtmlReporter.config().setReportName(GetFrameworkKeys.getPropValue("ReportName")+" - "+ FrameworkVariables.env.toUpperCase()+" Environment");
    ...
    public static void logoIntegration(){
        ...
        els.html(els.html().replaceAll("https://cdn.jsdelivr.net/gh/extent-framework/extent-github-cdn@b00a2d0486596e73dd7326beacf352c639623a0e/commons/img/logo.png","https://drive.google.com/path"));

        Element body = doc.body();
        body.html(body.html().replaceAll("https://cdn.jsdelivr.net/gh/extent-framework/extent-github-cdn@b00a2d0486596e73dd7326beacf352c639623a0e/commons/img/logo.png","https://drive.google.com/upath"));
